                     ...
                     int32_T indexSize)
{
  ...
  st.prev = &sp;
  st.tls = sp.tls;
  if ((matrixSize[1] == 1) && (indexSize != 1) && (indexSize == 1)) {
    c = true;
  } else {
    c = false;
  }
  ...
  if (nonSingletonDimFound) {
    ...
    if (nonSingletonDimFound) {
      emlrtErrorWithMessageIdR2018a(
          &st, &d_emlrtRTEI, "Coder:FE:PotentialMatrixMatrix_MM_Logical1",
    ...
    if (nonSingletonDimFound) {
      ...
      if (nonSingletonDimFound) {
        emlrtErrorWithMessageIdR2018a(
            &st, &d_emlrtRTEI, "Coder:FE:PotentialMatrixMatrix_MM_Logical2",
